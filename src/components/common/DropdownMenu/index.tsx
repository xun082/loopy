...
const dropdownClassName = (baseClass: string, inset?: boolean, className?: string) =>
  cn(baseClass, inset && 'pl-8', className);
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={dropdownClassName('px-2 py-1.5 text-sm font-semibold', inset, className)}
    {...props}
  />
));
