...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex justify-center min-h-[calc(100vh-60px)] pt-4">
      <div className="max-w-[1440px] w-full flex gap-5 px-4">
        {/* 左侧导航栏 */}
        <div className="w-[240px] shrink-0">
          <div className="fixed w-[240px] top-[76px] bg-white dark:bg-[#1d2127] rounded-lg">
            <nav className="py-4">
        ...
        {/* 中间内容区 */}
        <main className="flex-1 max-w-[720px] min-h-[calc(100vh-76px)] bg-white dark:bg-[#1d2127] rounded-lg p-4">
          {children}
        </main>

        {/* 右侧边栏 */}
        <div className="w-[240px] shrink-0">
          <div className="fixed w-[240px] top-[76px] space-y-4">
            <div className="bg-white dark:bg-[#1d2127] rounded-lg p-4">
